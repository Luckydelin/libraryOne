...
void GameApp::UpdateQuad()
{
    ...
    ImGui::SliderFloat("QuadEdgeTess", m_QuadEdgeTess, 1.0f, 100.0f, "%.1f");
    ImGui::SliderFloat("QuadInsideTess", m_QuadInsideTess, 1.0f, 100.0f, "%.1f");
...
bool GameApp::InitResource()
{
    ...
    XMFLOAT4 quadVertices[2] = {
        XMFLOAT4(0, 0.0f, 0.0f,2),
        XMFLOAT4(2.0f, 2.0f,2.0f,500)
